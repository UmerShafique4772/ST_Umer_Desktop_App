...
//        org = org.getInstance();
    ...
    String oldUsername;
    public UpdateProfile(Organization o,Admin a) {
        org = o;
        admin =a;
        this.oldUsername =a.getUserName();
        initComponents();
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jTextField4.setText(admin.getUserName());
        ...
        jPasswordField2.setText(admin.getpassword());
        ...
        jTextField5.setText(admin.getCity());

        jTextField6.setText(admin.getPhoneNo());

        jLabel9.setText("Phone No.");

        jTextField7.setText(admin.getEmail());

        jLabel10.setText("Email:");

        Date date = admin.getJoiningDate();
        ...
        jComboBox8.setSelectedItem(mon);
        ...
        Date date2 = admin.getDateOfBirth();
        String dd2 = df.format(date2);
        String [] db2 = dd2.split("/");
        String    yy2 = db2[0];
        String    mon2 = db2[1];
        String    dt2 = db2[2];
        jComboBox10.setSelectedItem(yy2);
        ...
        jComboBox11.setSelectedItem(mon2);
        ...
        jComboBox12.setSelectedItem(dt2);
