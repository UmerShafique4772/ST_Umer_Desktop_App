...
public class UpdateDonor extends javax.swing.JFrame {
    ...
    int id = -1;
    Donor oldD;
    public UpdateDonor(int idD,Donor d) {
        id = idD;
        oldD = d;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Update Donor", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        jTextField1.setText(oldD.getName());

        jTextField2.setText(Integer.toString(oldD.getDonorId()));

        jTextField3.setText(oldD.getCity());

        jTextField4.setText(oldD.getCountry());

        jTextField5.setText(oldD.getPhoneNo());

        jTextField6.setText(oldD.getEmail());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(!isNumeric(jTextField2.getText()))
        {
            ...
            int donorId = Integer.parseInt(jTextField2.getText());
            ...
            Donor v = new Donor(donorId,name,date,city,country,phoneNo,email);
            Organization org = new Organization();
            org= org.getInstance();
            org.UpdateDonor(v,id);
        }
